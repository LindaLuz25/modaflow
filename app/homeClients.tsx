    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView ref={mainScrollRef} showsVerticalScrollIndicator={false} style={styles.container}>
        ...
        <View style={styles.footer}>
          ...
          {/* NUEVO BLOQUE TIPO WEB */}
          <View style={styles.footerColumns}>

            <View style={styles.footerCol}>
              <Text style={styles.footerHeading}>SOBRE MODAFLOW</Text>
              <Text style={styles.footerSmallText}>
                ModaFlow es tu destino para moda minimalista y contemporánea.
                Ofrecemos piezas cuidadosamente seleccionadas que combinan estilo, calidad y sostenibilidad.
              </Text>

              <Text style={styles.footerSmallText}>Email: info@modaflow.com</Text>
              <Text style={styles.footerSmallText}>Teléfono: +51 999 888 777</Text>
            </View>

            <View style={styles.footerCol}>
              <Text style={styles.footerHeading}>ENLACES RÁPIDOS</Text>
              <Text style={styles.footerLink}>Políticas de Devolución</Text>
              <Text style={styles.footerLink}>Términos y Condiciones</Text>
              <Text style={styles.footerLink}>Preguntas Frecuentes</Text>
              <Text style={styles.footerLink}>Guía de Tallas</Text>
            </View>

            <View style={styles.footerCol}>
              <Text style={styles.footerHeading}>NUESTRA TIENDA</Text>
              <Text style={styles.footerSmallText}>
          ...
          {/* TU MAPA (igual que ya lo tienes) */}
